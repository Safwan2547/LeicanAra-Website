...
const Navbar = () => {
    ...
    return (
        ...
        flex align-middle justify-between cursor-none fixed top-5 left-5 right-5 sm:top-8 sm:mr-5 sm:ml-5 z-10`} >
            <Link to="/" className='transform transition-button duration-500 hover:scale-110 hover:text-LunarTwilight  buttonC font-Satoshi text-xl sm:text-3xl font-extralight cursor-none'>LeicanAra</Link>
  ...
  <div className="absolute inset-x-0 top-1/2 bg-black h-0.5 w-5 transform"></div>
                ...
                <Link to="/ContactPage" className='hover:text-LunarTwilight transform transition-button duration-500 hover:scale-110 hidden lg:block buttonC font-Satoshi text-2xl font-medium cursor-none'>Contact</Link>
