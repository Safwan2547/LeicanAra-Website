...
const Navbar = () => {
    ...
    return (
        <nav className={`transition-opacity ease-expo duration-1000  ${isMounted ? 'opacity-100' : 'opacity-0'} flex align-middle justify-between cursor-none fixed top-5 left-5 right-5 lg:p-3p-1`} >
            <Link to="/" className=' buttonC font-Satoshi text-2xl sm:text-3xl font-medium cursor-none'>LeicanAra</Link>
